...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const description = document.querySelector('.container .intro');
...
document.addEventListener('DOMContentLoaded', () => {
    const header = document.querySelector('.header');
    const d3 = document.querySelector('.Page .d1');

    window.addEventListener('scroll', () => {
        // Get the top position of the description relative to the viewport
        const d3Top = d3.getBoundingClientRect().top;

        // Check if the header height overlaps with the description
        if (d3Top <= header.offsetHeight) {
...
document.addEventListener('DOMContentLoaded', () => {
    const header = document.querySelector('.header');
    const d3 = document.querySelector('.Page .d2');
    ...
    window.addEventListener('scroll', () => {
        ...
        // Check if the header height overlaps with the description
        if (d3Top <= header.offsetHeight) {
            header.classList.add('scrolled3');
        } else {
            header.classList.remove('scrolled3');
        }
    });
});
document.addEventListener('DOMContentLoaded', () => {
    const header = document.querySelector('.header');
    const d3 = document.querySelector('.Page .d3');
    ...
    window.addEventListener('scroll', () => {
        ...
        // Check if the header height overlaps with the description
        if (d3Top <= header.offsetHeight) {
            header.classList.add('scrolled4');
        } else {
            header.classList.remove('scrolled4');
        }
    });
});
document.addEventListener('DOMContentLoaded', () => {
    const header = document.querySelector('.header');
    const d3 = document.querySelector('.Page .d4');
    ...
    window.addEventListener('scroll', () => {
        ...
        // Check if the header height overlaps with the description
        if (d3Top <= header.offsetHeight) {
            header.classList.add('scrolled5');
        } else {
            header.classList.remove('scrolled5');
        }
    });
});
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    headerTextElement.textContent = 'Welcome to Our Page!';
